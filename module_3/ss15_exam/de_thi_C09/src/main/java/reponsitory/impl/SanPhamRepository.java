...
public class SanPhamRepository implements ISanPhamRepository {
    ...
    public void createSanPham(SanPham sanPham) {
        ...
        try {
            PreparedStatement preparedStatement = connection.prepareStatement("Insert into san_pham ( ten, gia, so_luong, id_mau_sac, mo_ta, id_danh_muc) values (?,?,?,?,?,?);");
            ...
            preparedStatement.setInt(4, sanPham.getIdMauSac());
