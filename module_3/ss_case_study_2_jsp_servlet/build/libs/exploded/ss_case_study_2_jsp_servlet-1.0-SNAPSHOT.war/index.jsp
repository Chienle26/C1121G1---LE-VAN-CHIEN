...
<head>
    ...
    <style>
        .navbar navbar-light bg-light, navbar navbar-expand-lg navbar-light bg-light{
            padding-top: 0;
            padding-bottom: 0;
        }
...
<header>
    <nav class="navbar navbar-light bg-light">
        <a class="navbar-brand" href="#">
            <img src="https://furamavietnam.com/wp-content/uploads/2018/08/logo.png" width="31.5" height="50"
                 class="d-inline-block align-top" alt="">
        </a>
        <p style="text-align: right">LÊ VĂN CHIẾN</p>
    </nav>
