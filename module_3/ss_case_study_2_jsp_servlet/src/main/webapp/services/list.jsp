...
<div class="body">
    <center>
        <h1 style="margin-top: 10px">Service Application</h1>
    ...
    <table border="1" id="example" class="table table-striped table-bordered">
        ...
        <tbody>
        <c:forEach var="customer" items="${facilityList}">
            <tr>
                <td><c:out value="${customer.serviceCode}"/></td>
                <td><c:out value="${customer.nameService}"/></td>
                <td><c:out value="${customer.area}"/></td>
                <td><c:out value="${customer.rentalCosts}"/></td>
                <td><c:out value="${customer.maxPeople}"/></td>
                <td><c:out value="${customer.standardRoom}"/></td>
                <td><c:out value="${customer.description}"/></td>
                <td>
                    <a href="/users?action=edit&id=${customer.serviceCode}">Edit</a>
                    <a href="/users?action=delete&id=${customer.serviceCode}">Delete</a>
                </td>
            </tr>
        </c:forEach>
        </tbody>
