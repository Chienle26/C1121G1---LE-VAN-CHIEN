...
<div class="body">
    <center>
        <h1 style="margin-top: 10px">Employee Application</h1>
    ...
    <table border="1" id="example" class="table table-striped table-bordered">
        ...
        <c:forEach var="customer" items="${employeeList}">
            <tr>
                ...
                <td>
                    <a href="/users?action=edit&id=${customer.employeeCode}">Edit</a>
                    <a href="/users?action=delete&id=${customer.employeeCode}">Delete</a>
                </td>
            </tr>
        </c:forEach>
        </tbody>
