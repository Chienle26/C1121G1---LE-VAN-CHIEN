...
<div class="body">
    <center>
        <h1 style="margin-top: 10px">Contract Application</h1>
    ...
    <table border="1" id="example" class="table table-striped table-bordered">
        ...
        <c:forEach var="customer" items="${contractList}">
            <tr>
                ...
                <td><c:out value="${customer.deposit}"/></td>
                <td>
                    <a href="/contracts?action=edit&id=${customer.contractId}">Edit</a>
                    <a href="/contracts?action=delete&id=${customer.contractId}">Delete</a>
                </td>
            </tr>
        </c:forEach>
        </tbody>
