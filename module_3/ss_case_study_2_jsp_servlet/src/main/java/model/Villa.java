...
public class Villa extends Facility{
    ...
    public Villa(String nameService, Double area, Double rentalCosts, Integer maxPeople, Integer rentalType, String roomStandard, Double poolArea, Integer numberOfFloors) {
