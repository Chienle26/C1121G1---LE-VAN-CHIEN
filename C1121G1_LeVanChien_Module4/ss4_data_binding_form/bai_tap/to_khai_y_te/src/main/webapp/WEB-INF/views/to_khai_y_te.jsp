...
<div class="container text-center">
    <div class="row">
        <h1>Tờ Khai Y Tế</h1>
        <h3>ĐÂY LÀ TÀI LIỆU QUAN TRỌNG, THÔNG TIN CỦA ANH/CHỊ SẼ GIÚP Cơ QUAN Y TÉ LIÊN LẠC KHI CÀN THIẾT ĐỂ PHÒNG CHÓNG DỊCH BỆNH TRUYỀN NHIỄM</h3>
        <h5 style="color: red">Khuyến cáo: Khai báo thông tin sai là vi phạm pháp luật Việt Nam và có thể xử lý hình sự</h5>
        <h6 class="text-danger">${message}</h6>
    </div>
</div>
<form:form action="/tokhaiyte" method="post" modelAttribute="toKhaiYTe">
    <div class="container">
        <div class="row">
